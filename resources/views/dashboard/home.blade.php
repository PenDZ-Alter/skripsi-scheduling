...
@section('content')
    ...
    <div style="background-color: #FFFFFF" class="p-6 rounded-md relative overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-10">
            <img src="{{ asset('storage/img/Background.jpeg') }}" alt="Background"
                style="height: 250px; opacity: 20%" class="w-full h-full object-cover grayscale">
        </div>
        ...
        <div class="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
            ...
            <div class="flex items-start space-x-4">
                <img src="{{ asset('storage/img/Alfariz.png') }}" alt="Foto Profil" style="height: 160px; width: 140px"
                    class="w-auto shadow rounded-md">
                <div style="margin-top: 15px; margin-left: 40px">
                    <h3 class="text-xs font-bold">Info Profil & Email UIN, Klik <a href="#"
                      style="font-size:0.90rem;" class="text-blue-600"><u>Di SINI</u></a></h3>
                    <p style="margin-top:5px" class="text-sm font-semibold"> - Default password email sesuai siakad</p>
                    <p style="margin-top:5px" class="text-sm font-semibold"> - Ubah password email, klik <a href="#" class="text-blue-600">Di
                                SINI</a></p>
                    <p style="margin-top:5px" class="text-sm font-semibold"> - Buka email UIN, klik <a href="#" class="text-blue-600">gmail.com</a></p>
                    <p style="margin-left: 10px" class="text-sm font-semibold"> Add account: <i style="margin-right:-1px;">NIM</i>@student.uin-malang.ac.id</p>
                    <p style="margin-top:5px" class="text-sm font-semibold"> - Untuk aktivasi email UIN, klik <a href="#" class="text-blue-600">Di
                                SINI</a></p>
                </div>
            </div>
            ...
            <div>
                <h3 style="text-align: right; font-size: 1.50rem; font-weight: 300;" class="text-right mb-4">Free Access Journal</h3>
                <div class="space-y-2">
                    <a href="https://link.springer.com/" style="display: block; background: linear-gradient(to right, rgba(254, 215, 170, 0.2), #fed7aa); text-align: right; font-size: 0.80rem;"
                    ...
                    <a href="https://www.emerald.com/insight/" style="display: block; background: linear-gradient(to right, rgba(190, 242, 100, 0.2), #bef264)
                  ; text-align: right; font-size: 0.80rem;"
                        class="px-4 py-4 font-semibold text-gray-700 rounded">
                        Free Access Emerald Insight <span style="font-size: 1.2rem; font-weight: 700;">&laquo;</span>
                    </a>
                    <a href="https://www.cambridge.org/core/" style="display: block; background: linear-gradient(to right, rgba(254, 240, 138, 0.2), #fef08a); text-align: right; font-size: 0.80rem;"
                        class="px-4 py-4 font-semibold text-gray-700 rounded">
    ...
    <div class="bg-white p-4 mt-6 rounded-md shadow text-center">
        ...
        <p style="letter-spacing:1px; font-weight:500;" class="text-sm text-gray-600 mb-4">220605110025 - <span style="letter-spacing:0px;">ALFARIZ MUHAN MANDEGA</span></p>
