<div
    class="fixed top-0 left-0 w-64 h-screen text-white flex flex-col z-50">
    ...
    <div class="flex items-center gap-3 p-4">
        <!-- Foto Profil -->
        <!-- <a href="{{ route('profile') }}" class="profile1">
            <img src="{{ asset('storage/img/Alfariz.png') }}" alt="Profile" class="profile-picture">
        </a> -->

        <!-- Nama dan NIM -->
        <div style="margin-left:5px;" class="flex flex-col">
            <span class="name-profile">ALFARIZ MUHAN M</span>
        ...
        <ul>
            ...
            <li class="px-4 py-2">
                <span class="sidebar-content">
                    ...
                    <a href="{{ route('pembayaran') }}" class="text-style">Rekap Pembayaran</a>
                </span>
            </li>
            <li class="px-4 py-2">
                <span class="sidebar-content">
            ...
            <li class="px-4 py-2">
                <span class="sidebar-content">
                    ...
                    <a href="{{ route('statistik') }}" class="text-style">Statistik Akademik</a>
                </span>
            </li>
            <li class="px-4 py-2">
                <span class="sidebar-content">
            ...
            <li class="px-4 py-2 hover:bg-green-800">
                <span class="sidebar-content">
                    <a href="{{ route('skripsi') }}">
                        <i class="fas fa-flag-checkered icon-style"></i>
                    </a>
                    <a href="{{ route('skripsi') }}" class="text-style">Skripsi/Tesis/Disertasi</a>
                </span>
            </li>
            <li class="px-4 py-2 hover:bg-green-800">
                <span class="sidebar-content">
